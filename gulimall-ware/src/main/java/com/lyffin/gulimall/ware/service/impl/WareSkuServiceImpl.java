...
import com.lyffin.gulimall.ware.feign.ProductFeignService;
...
import com.lyffin.gulimall.ware.dao.WareSkuDao;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        if (StringUtils.hasLength(skuId) && !"0".equalsIgnoreCase(skuId)) {
            queryWrapper.eq("sku_id",skuId);
        }

        String wareId = (String) params.get("wareId");
        if (StringUtils.hasLength(wareId) && !"0".equalsIgnoreCase(wareId)) {
