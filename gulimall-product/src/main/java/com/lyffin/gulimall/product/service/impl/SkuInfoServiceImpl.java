...
import com.lyffin.gulimall.product.dao.SkuInfoDao;
import com.lyffin.gulimall.product.entity.SkuInfoEntity;
import com.lyffin.gulimall.product.service.SkuInfoService;
...
public class SkuInfoServiceImpl extends ServiceImpl<SkuInfoDao, SkuInfoEntity> implements SkuInfoService {
    ...
    public PageUtils queryPageByCondition(Map<String, Object> params) {
        ...
        if (StringUtils.hasLength(brandId) && !"0".equalsIgnoreCase(catelogId)) {
